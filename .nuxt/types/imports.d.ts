...
declare global {
  ...
  const useCalculator: typeof import('../../src/composables/useCalculator')['useCalculator']
...
declare global {
  ...
  import('vue')
  // @ts-ignore
  export type { CalculatorState } from '../../src/composables/useCalculator'
  import('../../src/composables/useCalculator')
}
...
declare module 'vue' {
  interface ComponentCustomProperties {
    ...
    readonly useCalculator: UnwrapRef<typeof import('../../src/composables/useCalculator')['useCalculator']>
